...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com/?lines=Hi+👋,+I'm+Chidera;A+MERN+stack+developer;with+over+4+years+Experience;building+unique+softwares;that+solve+problems;I+am+skilled+in+TypeScript;Javascript+Node+JS+Express;GraphQl+,React+,NextJS;MongoDB+,Postgres+,SQL+,GCP+,AWS;Docker+,Kubernates+,VMware+,MCP;HTML/CSS+,PHP;and+many+others&font=Fira%20Code&center=true&width=380&height=50">
</p>
